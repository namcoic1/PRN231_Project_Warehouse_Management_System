...
// load list customers by role admin
$(document).ready(function () {
    ...
    if(localStorage.getItem('token') && localStorage.getItem('role') === 'ADMIN') {
        title.html(`<h4 class="my-4">List Customers</h4>`);
        content.html(`<div class="d-flex my-2">
        <div>
            <span style="color:green">Show</span>/<span style="color:red">Hidden</span> columns:
            <span class="btn-sm btn-primary columns" data-column="0">Customer Id</span>
            <!--<span class="btn-sm btn-primary columns" data-column="1">Customer Name</span>-->
...
function listCustomers() {
    $.ajax({
        url: 'https://localhost:7210/odata/Customers',
        type: 'GET',
