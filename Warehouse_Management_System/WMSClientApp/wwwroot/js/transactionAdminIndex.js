...
// load list transactions by role admin
$(document).ready(function () {
    ...
    if (localStorage.getItem('token') && localStorage.getItem('role') === 'ADMIN') {
        ...
        <div>
            ...
            <span class="btn-sm btn-primary columns" data-column="2">Customer</span>
            <span class="btn-sm btn-primary columns" data-column="3">Supplier</span>
...
function listTransactions() {
    $.ajax({
        url: 'https://localhost:7210/odata/Transactions?$expand=User,Customer,Carrier,Supplier,Location,Product',
        type: 'GET',
